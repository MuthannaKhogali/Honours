...
const generateQuestions = async (transcript) => {
    try {
        const response = await axios.post(
            ...
            {
                contents: [{ parts: [{ text: `Read these subtitles: ${transcript}. Generate 5 multiple-choice questions with an answer key at the end. I only want you to do this not to say something like "Here is your generated questions"` }] }]
            },
            {
                headers: {
